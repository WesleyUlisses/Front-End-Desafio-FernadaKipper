...
@Component({
  ...
  standalone: true,
  imports: [ CommonModule, AppHeaderLandingPageComponent, AppFirstSectionLandingPageComponent, AppSecondSectionLandingPageComponent, AppThirdSectionLandingPageComponent ],
  providers: [ Router ],
